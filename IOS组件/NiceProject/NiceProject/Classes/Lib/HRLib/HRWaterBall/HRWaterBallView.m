...
#define DefaultFirstWaveColor [UIColor colorWithRed:34/255.0 green:116/255.0 blue:210/255.0 alpha:1]
#define DefaultSecondWaveColor [UIColor colorWithRed:34/255.0 green:116/255.0 blue:210/255.0 alpha:0.3]




@interface HRWaterBallView ()
...
@implementation HRWaterBallView
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.waveHeight = 5.0;
        self.firstWaveColor = DefaultFirstWaveColor;
        self.secondWaveColor = DefaultSecondWaveColor;
...
{
    self.timer = [CADisplayLink displayLinkWithTarget:[YYTextWeakProxy proxyWithTarget:self] selector:@selector(waveAnimation)];
